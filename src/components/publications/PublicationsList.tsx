...
export default function PublicationsList({ config, publications, embedded = false }: PublicationsListProps) {
    ...
    const hideBibtex = config.source === 'projects.bib';
            ...
            <div className="mb-8 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="relative flex-grow">
                        ...
                        <input
                            type="text"
                            placeholder={config.source === 'projects.bib' ? "Search projects..." : "Search publications..."}
                            value={searchQuery}
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-grow">
                                    ...
                                    {pub.keywords && pub.keywords.length > 0 && (
                                        <div className="flex flex-wrap gap-2 mt-3">
                                            {pub.keywords.map(tag => (
                                                <span key={tag} className="text-xs font-medium text-neutral-600 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-800 px-2 py-1 rounded-full border border-neutral-200 dark:border-neutral-700">
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    <AnimatePresence>
                                        ...
                                        {!hideBibtex && expandedBibtexId === pub.id && pub.bibtex ? (
                                            <motion.div
                                                key="bibtex"
                                                initial={{ opacity: 0, height: 0 }}
                                                animate={{ opacity: 1, height: 'auto' }}
